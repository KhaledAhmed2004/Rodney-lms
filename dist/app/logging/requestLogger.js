...
const requestLogger = (req, res, next) => {
    ...
    res.on('finish', () => {
        ...
        try {
            if ((_h = (_g = config_1.default.tracing) === null || _g === void 0 ? void 0 : _g.performance) === null || _h === void 0 ? void 0 : _h.enabled) {
                if (config_1.default.tracing.performance.captureMemory) {
        ...
        try {
            const m = (0, requestContext_1.getMetrics)();
            if (((_k = (_j = config_1.default.tracing) === null || _j === void 0 ? void 0 : _j.performance) === null || _k === void 0 ? void 0 : _k.enabled) &&
                ...
                if (perf.memoryStart && perf.memoryEnd) {
                    ...
                    if (growthMB > 50) {
                        ...
                        const isCryptoOperation = ((_l = req.originalUrl) === null || _l === void 0 ? void 0 : _l.includes('/auth/')) ||
                            ((_m = req.originalUrl) === null || _m === void 0 ? void 0 : _m.includes('/login')) ||
                            ((_o = req.originalUrl) === null || _o === void 0 ? void 0 : _o.includes('/register')) ||
                            ((_p = req.originalUrl) === null || _p === void 0 ? void 0 : _p.includes('/reset-password'));
                        if (hasFiles) {
                ...
                if (perf.cpuStart && perf.cpuEnd) {
                    ...
                    if (cpuOverhead > 100) {
                        ...
                        const isFileOperation = ((_u = req.originalUrl) === null || _u === void 0 ? void 0 : _u.includes('/upload')) ||
                ...
                if (perf.memoryStart && perf.memoryEnd && perf.cpuStart && perf.cpuEnd) {
                    ...
                    const cpuTime = (0, performanceMetrics_1.calculateCPUTime)(perf.cpuStart, perf.cpuEnd);
                    const cpuOverhead = (0, performanceMetrics_1.calculateCPUOverhead)(cpuTime.totalMs, processedMs);
                    const loopMetrics = ((_v = perf.eventLoopSamples) === null || _v === void 0 ? void 0 : _v.length)
