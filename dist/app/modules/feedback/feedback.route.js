...
// Public
router.get('/course/:courseId', feedback_controller_1.FeedbackController.getByCourse);
// Admin routes
...
router.get('/admin/summary', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN), feedback_controller_1.FeedbackController.getSummary);
router.get('/admin/:id', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN), feedback_controller_1.FeedbackController.getById);
