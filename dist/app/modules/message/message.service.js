...
const sendMessageToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Emit MESSAGE_SENT to chat room using SocketBuilder (type-safe)
    yield SocketBuilder_1.SocketBuilder
        .toChat(String(payload === null || payload === void 0 ? void 0 : payload.chatId))
        .emit('MESSAGE_SENT', {
        message: {
...
const markChatAsRead = (chatId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Emit MESSAGE_READ for each updated message to the chat room using SocketBuilder
    for (const msg of toUpdate) {
        yield SocketBuilder_1.SocketBuilder
            .toChat(String(chatId))
            .emit('MESSAGE_READ', {
