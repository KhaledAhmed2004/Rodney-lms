...
class PDFBuilder {
    ...
    toBuffer() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, builderTracing_1.traceOperation)('PDFBuilder', 'toBuffer', (span) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                const config = (0, builderConfig_1.getBuilderConfig)().pdf;
                (0, builderTracing_1.addSpanAttributes)({
                    'pdf.pageSize': this.config.pageSize,
                    'pdf.orientation': this.config.orientation,
                    'pdf.contentItems': this.config.content.length,
                    'pdf.theme': this.config.theme || 'default',
                });
                const browser = yield PDFBuilder.getBrowser();
                const page = yield browser.newPage();
                try {
                    // Pre-generate QR codes and barcodes
                    (0, builderTracing_1.recordSpanEvent)('processing_qr_barcodes');
                    yield this.processQRCodesAndBarcodes();
                    (0, builderTracing_1.recordSpanEvent)('building_html');
                    const html = this.buildHTML();
                    yield page.setContent(html, { waitUntil: 'networkidle0', timeout: config.puppeteerTimeout });
                    (0, builderTracing_1.recordSpanEvent)('generating_pdf');
                ...
                <span class="pageNumber"></span> / <span class="totalPages"></span>
                    ...
                    (0, builderTracing_1.addSpanAttributes)({ 'pdf.size': buffer.length });
                    return buffer;
                }
                catch (error) {
                    const builderError = BuilderError_1.BuilderError.from(error, 'PDFBuilder', 'toBuffer', {
                        pageSize: this.config.pageSize,
                        contentItems: this.config.content.length,
                    });
                    builderError.log();
                    throw builderError;
                }
    ...
    toFile(path) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, builderTracing_1.traceOperation)('PDFBuilder', 'toFile', () => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    (0, builderTracing_1.addSpanAttributes)({ 'pdf.filePath': path });
                }
                catch (error) {
                    const builderError = BuilderError_1.BuilderError.from(error, 'PDFBuilder', 'toFile', { path });
                    builderError.log();
                    throw builderError;
                }
            }));
    ...
    toBase64() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, builderTracing_1.traceOperation)('PDFBuilder', 'toBase64', () => __awaiter(this, void 0, void 0, function* () {
                try {
                    const buffer = yield this.toBuffer();
                    return buffer.toString('base64');
                }
                catch (error) {
                    const builderError = BuilderError_1.BuilderError.from(error, 'PDFBuilder', 'toBase64');
                    builderError.log();
                    throw builderError;
                }
            }));
  ...
  ${this.renderFooter()}
    ...
    generateQRCode(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (0, builderTracing_1.recordSpanEvent)('qrcode_generated', { dataLength: data.length });
                return dataUrl;
            }
            catch (error) {
                const builderError = BuilderError_1.BuilderError.from(error, 'PDFBuilder', 'generateQRCode', {
                    dataLength: data.length,
                });
                builderError.log('warn');
                return '';
            }
        });
    }
    generateBarcode(config) {
        ...
        try {
            ...
            (0, builderTracing_1.recordSpanEvent)('barcode_generated', { format, dataLength: data.length });
            return canvas.toDataURL('image/png');
        }
        catch (error) {
            const builderError = BuilderError_1.BuilderError.from(error, 'PDFBuilder', 'generateBarcode', {
                format,
                data,
            });
            builderError.log('warn');
