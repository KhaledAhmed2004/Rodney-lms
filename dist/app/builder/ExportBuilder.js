...
class ExportBuilder {
    ...
    toBuffer() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, builderTracing_1.traceOperation)('ExportBuilder', 'toBuffer', () => __awaiter(this, void 0, void 0, function* () {
                ...
                (0, builderTracing_1.addSpanAttributes)({
                    ...
                    'export.rows': this.data.length,
                    'export.columns': this.config.columns.length,
                    'export.theme': this.config.options.theme || 'default',
                });
                try {
                    let buffer;
                    switch (this.config.format) {
                        case 'excel':
                            (0, builderTracing_1.recordSpanEvent)('generating_excel');
                            buffer = yield this.generateExcel();
                            break;
                        case 'csv':
                            (0, builderTracing_1.recordSpanEvent)('generating_csv');
                            buffer = yield this.generateCSV();
                            break;
                        case 'json':
                            (0, builderTracing_1.recordSpanEvent)('generating_json');
                            buffer = this.generateJSON();
                            break;
                        case 'pdf':
                            (0, builderTracing_1.recordSpanEvent)('generating_pdf');
                            buffer = yield this.generatePDF();
                            break;
                        default:
                            throw new BuilderError_1.BuilderError(`Unsupported export format: ${this.config.format}`, 'ExportBuilder', 'toBuffer');
                    }
                    (0, builderTracing_1.addSpanAttributes)({ 'export.size': buffer.length });
                    return buffer;
                }
                catch (error) {
                    ...
                    const builderError = BuilderError_1.BuilderError.from(error, 'ExportBuilder', 'toBuffer', {
