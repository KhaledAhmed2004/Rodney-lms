        ...
        return __awaiter(this, void 0, void 0, function* () {
            return (0, builderTracing_1.traceOperation)('EmailBuilder', 'send', () => __awaiter(this, void 0, void 0, function* () {
                ...
                (0, builderTracing_1.addSpanAttributes)({
                    ...
                    'email.hasAttachments': !!((_a = options.attachments) === null || _a === void 0 ? void 0 : _a.length),
                });
                try {
                    ...
                    (0, builderTracing_1.recordSpanEvent)('sending_email');
                    yield transporter.sendMail(mailOptions);
                    (0, builderTracing_1.recordSpanEvent)('email_sent');
                }
                catch (error) {
                    const builderError = BuilderError_1.BuilderError.from(error, 'EmailBuilder', 'send', {
                        to: options.to,
                        subject: options.subject,
                    });
                    builderError.log();
